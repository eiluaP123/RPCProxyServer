...
void generate_random_distribution(SomethingClient client){
    ...
    for(int i=0; i<nrolls; i++){
        //std::cout << "starting of the loop" << std::endl;
        double number = rand()%15;
...
//        get_URLlist(client,argv[1]);
        generate_random_distribution(client);
//        client.ping();
        transport->close();
