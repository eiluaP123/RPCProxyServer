...
void SomethingClient::ping(std::string& _return, const std::string& url)
{
  send_ping(url);
  recv_ping(_return);
}

void SomethingClient::send_ping(const std::string& url)
{
  int32_t cseqid = 0;
...
void SomethingClient::recv_ping(std::string& _return)
{
